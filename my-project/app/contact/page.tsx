          ...
          <div className="w-full lg:w-1/2 relative flex flex-col items-center justify-center px-4 sm:px-6 md:px-8 py-8 sm:py-12 lg:py-16 min-h-screen">
            ...
            <div className="relative z-10 w-full max-w-lg">
              ...
              <form 
                ...
                className="w-full space-y-3 sm:space-y-4 bg-white/95 lg:bg-transparent p-6 sm:p-8 lg:p-0 rounded-3xl shadow-2xl lg:shadow-none backdrop-blur-sm lg:backdrop-blur-none"
              >
                <div>
                ...
                <div>
                  <label htmlFor="phone" className="block text-black mb-2 font-medium text-sm sm:text-base">
                    Phone number{' '}
                    <span className="text-red-600 text-xs sm:text-sm">(optional)</span>
                  </label>
                  <input
                    type="tel"
                    id="phone"
                ...
                <button
                  ...
                  className="w-full cursor-pointer text-white border border-black bg-black rounded-2xl py-2.5 sm:py-3 px-5 text-sm sm:text-base transition hover:shadow-[0_0_20px_black] hover:shadow-black-/50 duration-300 hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
                >
